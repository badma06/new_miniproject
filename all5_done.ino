...
#define RELAY_PIN 4             // GPIO for relay control (Peltier)
...
float tempThreshold = 34.00;                         // Default threshold (°C)
const float HIGH_TEMP_THRESHOLD = 34.0;              // Peltier ON threshold (Modified)
const float LOW_TEMP_THRESHOLD = 33.85;               // Peltier OFF threshold (Modified)
